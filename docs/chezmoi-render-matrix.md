...
| Context | develop | manage_lima_vms_from_this_host | has_gui | opencode | taskwarrior |
| --- | --- | --- | --- | --- | --- |
...
1. Set context values in chezmoi config:
   ...
   - Update the relevant values under your data block (`develop`, `manage_lima_vms_from_this_host`, `has_gui`, `opencode`, `taskwarrior`)
