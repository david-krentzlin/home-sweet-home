...
dnf install -y git curl sudo ca-certificates chezmoi zsh zsh-autosuggestions openssh-clients tmux ripgrep fd-find bat eza zoxide fzf jq tar unzip gzip make gcc gcc-c++ helm acl
